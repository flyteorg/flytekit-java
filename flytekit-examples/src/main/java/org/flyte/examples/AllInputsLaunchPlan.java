...
public class AllInputsLaunchPlan extends SimpleSdkLaunchPlanRegistry {

  public AllInputsLaunchPlan() {
    // Register launch plan with fixed inputs using SdkType
    registerLaunchPlan(
        SdkLaunchPlan.of(new AllInputsWorkflow()).withName("AllInputsWorkflowLaunchPlan"));
  }
}
