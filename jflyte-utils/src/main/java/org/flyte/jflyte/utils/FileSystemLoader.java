...
public class FileSystemLoader {
  ...
  public static Map<String, FileSystem> loadFileSystems(Collection<ClassLoader> modules) {
  ...
  public static FileSystem getFileSystem(Map<String, FileSystem> fileSystems, String uri) {
