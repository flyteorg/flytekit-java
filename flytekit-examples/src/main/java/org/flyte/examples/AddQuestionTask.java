...
public class AddQuestionTask
    extends SdkRunnableTask<AddQuestionTask.Input, AddQuestionTask.Output, NopNamedOutput> {
   ...
   */
  public static SdkTransform<NopNamedOutput> of(SdkBindingData greeting) {
